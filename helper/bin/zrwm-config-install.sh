...
################################################################################
### Head: Model / mod_zrwm_config_install
##

mod_zrwm_config_install () {

	sys_zrwm_config_install
...
sys_zrwm_config_install () {
	...
	local src_dir_path="${REF_ASSET_DIR_PATH}/config/zrwm-config/overlay/etc/skel"
...
##
### Tail: Model / mod_zrwm_config_install
################################################################################


################################################################################
### Head: Portal / portal_zrwm_config_install
##

portal_zrwm_config_install () {
...
##
### Tail: Portal / portal_zrwm_config_install
################################################################################
